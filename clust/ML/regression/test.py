...
def getTestResult(dataName_X, dataName_y, modelName, DataMeta, ModelMeta, dataFolderPath, windowNum=0, db_client=None):
    ...
    # 4. Testing
    batch_size=1
    df_result, result_metrics = get_result_metrics(param, test_x, test_y, model_method, target, modelFilePath, scalerParam, scaler_y, windowNum=0)
...
def get_result_metrics(param, test_x, test_y, model_method, target, modelFilePath, scalerParam, scaler_y, windowNum=0):
