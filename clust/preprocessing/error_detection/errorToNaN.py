class errorToNaN():
    ...
    def dataRangeInfoManager(self, data_type):
        from clust.preprocessing.error_detection import dataRangeInfo_manager
    ...
    def getDataWithCertainNaN(self, data, CertainParam):
        if CertainParam['flag'] ==True:  
            from clust.preprocessing.error_detection import certainError
    ...
    def getDataWithUncertainNaN(self, data, uncertainParam):    
        if uncertainParam['flag'] == True:
            from clust.preprocessing.error_detection import unCertainError
