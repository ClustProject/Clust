...
class DfSetData():
    ...
    def multi_ms_one_enumerated_ms_in_bucket_integration(self, ingestion_param) :
        ...
        Returns:
            _Dictionary_ : bucket_dataSet(integrated data)
    ...
    def all_ms_in_multiple_bucket(self, ingestion_param):    
        ...
        Returns:
            _Dictionary_ : data_set

        >>> new DataSet (key name  ===> msName + bucketName)
